...
class TrendAnalyzer {
  ...
  extractTrendKeywords(results) {
    ...
    const trendPatterns = {
      'Минимализм': ['минимализм', 'простота', 'чистый дизайн', 'лаконичность', 'простые формы'],
      'Винтаж/Ретро': ['винтаж', 'ретро', '80-е', '90-е', 'классика', 'олдскул'],
      'Яркие цвета': ['неон', 'яркие', 'кислотные', 'флуоресцентные', 'насыщенные цвета'],
      'Геометрия': ['геометрия', 'геометрические', 'линии', 'формы', 'треугольники', 'круги'],
      'Природа': ['природа', 'растения', 'листья', 'цветы', 'эко', 'органические'],
      'Типографика': ['типографика', 'шрифт', 'буквы', 'текст', 'надписи', 'слоганы'],
      'Градиенты': ['градиент', 'переходы', 'омбре', 'плавные'],
      'Космос': ['космос', 'звезды', 'планеты', 'галактика', 'вселенная'],
      'Поп-культура': ['аниме', 'мем', 'игры', 'фильмы', 'сериалы'],
      'Мотивация': ['мотивация', 'вдохновение', 'цитаты', 'позитив']
    };
