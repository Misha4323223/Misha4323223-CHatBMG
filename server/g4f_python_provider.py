...
def get_demo_response(message):
    ...
    if "📡 ИНФОРМАЦИЯ ИЗ ИНТЕРНЕТА:" in message:
        ...
        if any(word in message_lower for word in ['магазин', 'одежда', 'торговый']):
            ...
            return "Я нашел информацию о магазинах в интернете. Для поиска конкретных магазинов уличной одежды в Санкт-Петербурге рекомендую использовать:\n\n• 2ГИС - для поиска по адресам и часам работы\n• Яндекс.Карты - с отзывами и рейтингами\n• Google Maps - для навигации\n• Авито/OLX - для поиска б/у одежды\n\nПопулярные районы для поиска: Невский проспект, Садовая улица, торговые центры \"Галерея\", \"Европейский\"."
