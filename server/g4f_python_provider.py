...
def get_demo_response(message):
    ...
    if "📡 ИНФОРМАЦИЯ ИЗ ИНТЕРНЕТА:" in message:
        ...
        if any(word in message_lower for word in ['магазин', 'одежда', 'торговый']):
            print("🔍 [DEMO] Обнаружен запрос о магазинах!")
...
• **Henderson** - Большая Конюшенная ул., 19 (мужская одежда)
...
**Торговые центры:**
• **ТЦ Европейский** - Площадь Киевского Вокзала, 2
• **ТЦ Атриум** - Ленинградский пр., 37А
• **ТЦ Охотный ряд** - Манежная пл., 1

**Специализированные магазины:**
• **Streetbeat** - сеть магазинов уличной одежды
• **Brandshop** - несколько точек по городу
• **Respect** - молодежная мода
...
• Китай-город"""
                ...
                return "Я нашел информацию о магазинах в интернете. Уточните, пожалуйста, в каком городе вы ищете магазины уличной одежды, чтобы я мог предоставить конкретные адреса и названия."
